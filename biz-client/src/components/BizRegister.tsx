...
interface BizRegisterProps {}

const BizRegister: FunctionComponent<BizRegisterProps> = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      let user: User = { ...values, isBiz: true };
    ...
    <>
      <div className=" p-5">
        <div className="shadow p-3 bg-light mb-5 rounded mx-auto w-50">
          <h1 className="text-center mt-4">Business Register</h1>
